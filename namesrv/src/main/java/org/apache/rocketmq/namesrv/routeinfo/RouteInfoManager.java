...
public class RouteInfoManager {
    ...
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                ...
                // 如果在 brokerAddrTable 里没有这个 brokerName 对应的消息说明是第一次注册
                // 则创建一个新的 BrokerData 对象并放入 brokerAddrTable 里
                ...
                // 获取 brokerName 对应的所有主备 broker 信息
                ...
                // 更新 brokerData 消息里主备 broker 的信息
    ...
    private void createAndUpdateQueueData(final String brokerName, final TopicConfig topicConfig) {
        ...
        // 空说明则需要创建队列信息并放入 topicQueueTable 里
        if (null == queueDataList) {
            ...
            // 通过 queueData 的迭代器循环遍历
            Iterator<QueueData> it = queueDataList.iterator();
            while (it.hasNext()) {
                QueueData qd = it.next();
                // 如果队列的 brokerName 和我们需要创建 brokerName 相同说明不是新的队列
    ...
    public void scanNotActiveBroker() {
        // 获取 brokerLiveTable 里的所有活跃的 broker
        Iterator<Entry<String, BrokerLiveInfo>> it = this.brokerLiveTable.entrySet().iterator();
        // 遍历 broker 列表，如果上次接收的 broker 的心跳时间 + 120S 小于当前时间说明已经超过 120S 没有接收到 broker 发送的心跳
        // 则会把它在 brokerLiveTable 里删除
        while (it.hasNext()) {
            ...
            if ((last + BROKER_CHANNEL_EXPIRED_TIME) < System.currentTimeMillis()) {
                ...
                // 到 filterServerTable、brokerAddrTable、topicQueueTable 里删除对应的 broker
